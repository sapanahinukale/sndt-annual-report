...
const reportSchema = new mongoose.Schema({
  ...
  section3:  { organizedEvents:[Mixed], otherEvents:[Mixed], otherEventsImages:[String], facultyPapers:[Mixed], facultyWorkshops:[Mixed], facultyDevelopment:[Mixed] },
  ...
  section8:  { workshops:[Mixed], nssActivities:String, nssImages:[String], teachingQuality:String, otherActivities:String, otherActivitiesImages:[String] },
